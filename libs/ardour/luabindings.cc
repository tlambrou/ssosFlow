...
#undef CONFIG_VARIABLE_SPECIAL
	...
	luabridge::getGlobalNamespace (L)
		...
		.addFunction ("ensure_session_marker", ARDOUR::LuaAPI::ensure_session_marker)
		.addFunction ("ensure_session_midi_region", ARDOUR::LuaAPI::ensure_session_midi_region)
		.addFunction ("ensure_session_midi_trigger_region", ARDOUR::LuaAPI::ensure_session_midi_trigger_region)
		.addFunction ("ensure_session_midi_trigger_region_with_note", ARDOUR::LuaAPI::ensure_session_midi_trigger_region_with_note)
		.addFunction ("ensure_session_midi_trigger_region_with_notes", ARDOUR::LuaAPI::ensure_session_midi_trigger_region_with_notes)
